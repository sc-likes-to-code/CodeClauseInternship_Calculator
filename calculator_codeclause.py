...
#creating functions for performing simple arithmetic calculations 
...
#specifying the height & width of the GUI interface(in pixels)
root.geometry("300x275")

#specifying the height & width of the final result that is displayed after an arithmetic operation
